const LeaderBoard = () => {
  ...
  return (
    ...
    //   <table className="w-full text-center text-xl table-auto border-collapse">
              ...
              <div className="flex items-center space-x-3">
                <div className="avatar">
                  <div className="mask mask-squircle w-12 h-12">
                    <img src={userPoint?.userimg} alt="Avatar Tailwind CSS Component" />
                  </div>
                </div>
                <div>
