    ...
    <div className="my-20">
      ...
      <div className="md:w-1/2 p-4">
        ...
        <div className="grid grid-cols-2 gap-5 mb-6">
            <div className="md:flex items-center gap-3 font-medium text-xl p-3 bg-indigo-100 drop-shadow-lg hover:skew-y-6 duration-500"><BsPatchQuestionFill className="text-red-400" /> <p>How to start?</p></div>
            <div className="md:flex items-center gap-3 text-xl p-3 bg-indigo-100 drop-shadow-lg hover:skew-y-6 font-medium duration-500"><RiLoginCircleFill className="text-blue-400" /> <p>Want To Login?</p></div>
      ...
      {/* -----img side----- */}
      <div className="md:w-1/2 relative bg-[#fca5a5c5] " style={{ "borderRadius": "50% 50% 50% 50% / 70% 70% 40% 40%" }}>
        <img className="w-full h-full " src="https://i.ibb.co/j5r61ng/transform-img.png" alt="faq-img" />
