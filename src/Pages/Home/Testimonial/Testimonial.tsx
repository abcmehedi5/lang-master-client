        ...
        <div className="flex flex-col items-center">
          ...
          <div className="relative mt-10 md:mt-24 md:order-2">
            ...
            <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
              {reviews.map(review => (
                <div key={review._id} className="flex flex-col overflow-hidden shadow-xl">
                  <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                    <div className="flex-1">
                      ...
                      <div className="flex items-center mt-8">
                                <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src={review.image} alt="" />
                                <div className="ml-4">
                                    <p className="text-base font-bold text-gray-900 font-pj">{review.name}</p>
                                    <p className="mt-0.5 text-sm font-pj text-gray-600">{review.passion}</p>
                                </div>
                        </div>
                    </div>
                  </div>
