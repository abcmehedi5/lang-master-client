...
const WhiteButton: React.FC<WhiteButtonProps> = ({
  ...
  const baseClasses = 'font-medium transition-all duration-500 ease-out active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none relative overflow-hidden';
